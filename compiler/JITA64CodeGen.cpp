...
JitA64EntryFn JITA64Backend::compileMainChunk(const CompileResult& result) {
    ...
    a.stp(a64::regs::x29, a64::regs::x30, a64::Mem(a64::regs::sp, -16, a64::Mem::OffsetMode::kPreIndex));
    a.stp(a64::regs::x19, a64::regs::x20, a64::Mem(a64::regs::sp, -16, a64::Mem::OffsetMode::kPreIndex));
    a.str(a64::regs::x21, a64::Mem(a64::regs::sp, -16, a64::Mem::OffsetMode::kPreIndex));
    ...
    for (size_t ip = 0; ip < codeBytes.size();) {
        ...
        auto op = static_cast<OpCode>(codeBytes[ip]);
        size_t nextIp = ip + opCodeSize(op);
        ...
        case OpCode::OP_SUBTRACT: {
            a.ldr(a64::regs::x1, a64::Mem(a64::regs::x21));
            a.add(a64::regs::x21, a64::regs::x21, 8);
        ...
        case OpCode::OP_SET_LOCAL: {
            ...
            a.ldr(a64::regs::x0, a64::Mem(a64::regs::x21));
            // str x0, [x20 - slot*8]
            a.str(a64::regs::x0, a64::Mem(a64::regs::x20, -static_cast<int32_t>(slot * 8)));
            break;
        }
        ...
        case OpCode::OP_GET_GLOBAL: {
            ...
            // ldr x0, [x1 + slot*8]
            a.ldr(a64::regs::x0, a64::Mem(a64::regs::x1, static_cast<int32_t>(slot * 8)));
            // push
            a.sub(a64::regs::x21, a64::regs::x21, 8);
            a.str(a64::regs::x0, a64::Mem(a64::regs::x21));
            break;
        ...
        case OpCode::OP_SET_GLOBAL: {
            ...
            a.ldr(a64::regs::x1, a64::Mem(a64::regs::x19, 24));
            // str x0, [x1 + slot*8]
            a.str(a64::regs::x0, a64::Mem(a64::regs::x1, static_cast<int32_t>(slot * 8)));
            break;
        }
    ...
    // 恢复 callee-saved 寄存器
    a.ldr(a64::regs::x21, a64::Mem(a64::regs::sp, 16, a64::Mem::OffsetMode::kPostIndex));
    a.ldp(a64::regs::x19, a64::regs::x20, a64::Mem(a64::regs::sp, 16, a64::Mem::OffsetMode::kPostIndex));
    a.ldp(a64::regs::x29, a64::regs::x30, a64::Mem(a64::regs::sp, 16, a64::Mem::OffsetMode::kPostIndex));
    a.ret(a64::regs::x30);
