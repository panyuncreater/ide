# 归档：v1.0.0（2026-07-24 ~ 2026-07-25 · 优化清单 P0-P3 + L1-L30 + W 系列完整收尾）

本文件归档自 CHANGELOG.md，保留 v1.0.0 版本的全部原始变更记录。v1.0.0 是 MiniLang IDE「优化清单 2026-07-23」的完整收尾版本，覆盖 P0/P1/P2/P3 优先级与 L1-L30 限制修复及 W1/W3/W4 工程基础设施任务。本版本以下条目按原始日期与主题分节保留，未做内容删改，仅供历史追溯。新版本变更请参阅根目录 CHANGELOG.md。
