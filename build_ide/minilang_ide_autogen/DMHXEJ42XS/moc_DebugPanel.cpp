/****************************************************************************
** Meta object code from reading C++ file 'DebugPanel.h'
**
...
#error "The header file 'DebugPanel.h' doesn't include <QObject>."
...
void DebugPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onStackFrameSelected((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
