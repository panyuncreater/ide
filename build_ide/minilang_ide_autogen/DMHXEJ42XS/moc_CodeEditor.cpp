...
template <> constexpr inline auto CodeEditor::qt_create_metaobjectdata<qt_meta_tag_ZN10CodeEditorE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'breakpointConditionRequested'
...
void CodeEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->breakpointConditionRequested((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CodeEditor::*)(int , const QString & )>(_a, &CodeEditor::breakpointConditionRequested, 0))
            return;
    }
}
...
// SIGNAL 0
void CodeEditor::breakpointConditionRequested(int _t1, const QString & _t2)
{
