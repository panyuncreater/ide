...
const std::vector<AstToyLevel>& AstToyLibrary::levels() {
    static const std::vector<AstToyLevel> kLevels = {
        ...
        AstToyLevel{1, "42",
                    ...
                    1, AstToyLevel::TreeNode{"Number:42"}},
        ...
        AstToyLevel{
            6, "var x = 1 + 2;",
            "🌳 完整语句 = 更大的树：变量声明 VarDecl 是根，它除了记录变量名 x，还挂着一个「初始化表达式子树」（这里是 "
            "1+2 的加法树）。\n"
            ...
            3,
            AstToyLevel::TreeNode{"VarDecl:x",
                                  {
                                      AstToyLevel::TreeNode{"BinaryOp:+",
                                                            {
                                                                AstToyLevel::TreeNode{"Number:1"},
