...
void IrViewer::setIR(const IRFunction* ir) {
    ...
    try {
        ...
        html += "<div style='font-family:\"Cascadia Code\",\"Cascadia Mono\",\"Consolas\",\"JetBrains Mono\",\"Source "
                "Code Pro\",\"Menlo\",\"DejaVu Sans Mono\",\"Courier New\",monospace;font-size:13px;line-height:1.6;'>";
...
void IrViewer::clearIR() {
    ...
    browser_->setText(QString::fromUtf8("<div style='color:#6E6E6E; padding:8px;'>"
