...
inline QColor learningStageColor(int stage) {
    switch (stage) {
        case 0: return QColor("#4CAF50");  // 阶段零：绿色（首次接触）
        case 1: return QColor("#FFC107");  // 阶段一：黄色（编译前端）
        case 2: return QColor("#2196F3");  // 阶段二：蓝色（执行引擎）
        case 3: return QColor("#9C27B0");  // 阶段三：紫色（深入理解）
        case 4: return QColor("#F44336");  // 阶段四：红色（实战训练）
        default: return QColor("#9E9E9E"); // 未开始/失败：灰色
    }
}
...
// 亮色固定配色（深色主题已移除）
// ============================================================
inline QColor ideBgMain()      { return QColor("#ffffff"); }
inline QColor ideBgPanel()     { return QColor("#f3f3f3"); }
inline QColor ideBgSidebar()   { return QColor("#f8f8f8"); }
inline QColor ideFgPrimary()   { return QColor("#1e1e1e"); }
inline QColor ideFgSecondary() { return QColor("#6e6e6e"); }
inline QColor ideBorder()      { return QColor("#e5e5e5"); }
inline QColor ideAccent()      { return QColor("#0078d4"); }
inline QColor ideHoverBg()     { return QColor("#f0f0f0"); }
inline QColor ideSelectedBg()  { return QColor("#e8e8e8"); }
inline QColor ideTitleBg()     { return QColor("#ffffff"); }
inline QColor ideStatusBg()    { return QColor("#f3f3f3"); }
inline QColor ideEditorBg()    { return QColor("#ffffff"); }
inline QColor ideLineNumBg()   { return QColor("#f5f5f5"); }
inline QColor ideLineNumFg()   { return QColor("#999999"); }
