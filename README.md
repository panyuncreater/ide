...
![Tests](https://img.shields.io/badge/tests-1759-brightgreen)
...
项目包含 **1759 个 GoogleTest 单元测试**（195 个测试套件），覆盖前端（Lexer/Parser）、解释器、编译器与虚拟机、IR 中间层、三后端一致性、格式化器、教学面板数据完整性等。
